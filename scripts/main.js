;(function (window) {
  ...
  let texts = ['TAP DIMANA AJA YA :)','JANGAN LUPA', 'PAKAI PC ATAU LAPTOP', 'AYY', 'COBA LIAT DEH', 'TULISAN INI', 'KAYA ADA YANG ANEH', 'OKE PENCET LAGI', 'AKU GA BOHONG KOK', 'PENCET LAGI', 'AKU TAU KAMU PASTI KESEL KAN', 'TAPI INI BENERAN ADA YANG ANEH', 'AKU JANJI', 'INI TERAKHIR KALI', 'PENCET LAGI', 'SEMANGAT CANTIK', 'KAMU PASTI BISA', 'IHHH KAMU KURANG PENCET ITU', 'AYO DONG', 'IYA INI BENER TERAKHIR KOK', 'YAUDA DEH', 'I', 'LOVE', 'YOU ♡', 'HEHE', 'MAAFIN AKU YA', 'KALO AKU BIKIN KAMU KESEL']
